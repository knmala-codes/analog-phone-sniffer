...
\( A_v = 1 + \dfrac{470\,000}{4\,700} \approx 101 \)
...
\( f_c = \dfrac{1}{2\pi R_{\text{in}} C_1} \)
...
\( f_c \approx \dfrac{1}{2\pi \cdot 100\,000 \cdot 1 \times 10^{-6}} \approx 1.6\,\text{Hz} \)
...
\( f_{c,\text{out}} = \dfrac{1}{2\pi R_{\text{load}} C_{\text{out}}} \)
...
\( I_{\text{LED}} \approx \dfrac{V_{\text{CC}} - V_{\text{LED}} - V_{\text{sat}}}{R_L} \)
